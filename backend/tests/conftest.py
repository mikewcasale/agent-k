...
@pytest.fixture
async def mock_async_client(mock_http_transport: httpx.MockTransport) -> AsyncIterator[httpx.AsyncClient]:
...
def mock_competitions() -> list[MockCompetition]:
    ...
    return [
        ...
        MockCompetition(id="sample-competition", title="Sample Competition"),
