...
export function PlanView() {
  ...
  if (!phases.length) {
    return (
      <div className="flex items-center gap-3 rounded-lg border border-zinc-300 border-dashed bg-white px-4 py-6 text-sm text-zinc-600 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300">
  ...
  return (
    <div className="space-y-6">
      <div className="relative space-y-6">
        <div className="absolute top-0 left-6 h-full w-0.5 bg-gradient-to-b from-blue-500/60 via-zinc-200 to-transparent dark:via-zinc-800" />
        {phases.map((phase) => (
          <div className="relative pl-14" key={phase.phase}>
            <div className="absolute top-6 left-5 size-3 rounded-full border-2 border-white bg-blue-500 shadow ring-2 ring-white dark:border-zinc-900 dark:ring-zinc-900" />
    ...
    >
      <div className="flex items-start gap-3 p-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-indigo-600 text-xs uppercase tracking-wide dark:text-indigo-300">
