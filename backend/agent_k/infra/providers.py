...
#
# Kept aligned with frontend/lib/ai/agent-k-models.ts DEFAULT_EVOLUTION_MODELS.
# Earlier free slugs (mistralai/devstral-2512:free, qwen/qwen3-coder:free,
# kwaipilot/kat-coder-pro:free) returned 404 / rate-limit upstream and were
# removed; do not reintroduce them without verifying availability.
