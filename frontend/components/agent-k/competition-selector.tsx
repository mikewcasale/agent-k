...
export function CompetitionSelector() {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-zinc-50 via-white to-blue-50">
      <div className="mx-auto w-full max-w-5xl px-4 py-10">
        <motion.div
          animate={{ opacity: 1, y: 0 }}
          className="rounded-3xl border border-zinc-200 bg-white/80 p-6 shadow-xl backdrop-blur md:p-8"
        ...
        >
              ...
              <button
                ...
                className={cn(
                  ...
                  mode === tab.id
                    ...
                    : "border-zinc-200 bg-white text-zinc-600 hover:border-blue-300 hover:bg-blue-50/70"
                )}
                onClick={() => {
                  setMode(tab.id);
                  setError(null);
          ...
          <div className="mt-6 rounded-2xl border border-zinc-100 bg-white p-5 shadow-sm">
            ...
            <p className="mb-6 text-sm text-zinc-500">{activeTab.description}</p>
