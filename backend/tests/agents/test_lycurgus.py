...
from agent_k.agents.lycurgus import LycurgusOrchestrator, LycurgusSettings, MissionStatus
...
class TestLycurgusSettings:
    ...
    def test_custom_config(self) -> None:
        ...
        config = LycurgusSettings(default_model="openai:gpt-4o", max_evolution_rounds=50)
...
class TestMissionStatus:
    ...
    def test_status_creation(self) -> None:
        ...
        status = MissionStatus(phase="discovery", progress=0.5, metrics={"competitions_found": 3})
...
class TestLycurgusOrchestrator:
    ...
    def test_validate_competition_id_valid(self) -> None:
        ...
        assert LycurgusOrchestrator.validate_competition_id("sample-competition")
