...
Provides factory functions for creating model instances, including
support for OpenAI-compatible endpoints like local LM Studio servers,
OpenRouter, and standard providers like Anthropic.
"""
...
ModelType = str  # Type alias for model identifiers
