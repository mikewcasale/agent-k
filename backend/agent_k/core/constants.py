...
@graph:
    id: agent_k.core.constants
    provides:
        - agent_k.core.constants
    pattern: constants

@agent-guidance:
    do:
        - "Use agent_k.core.constants as the canonical home for this capability."
    do_not:
...
MAX_EVOLUTION_GENERATIONS: Final[int] = 200
...
DEFAULT_MODEL: Final[str] = os.getenv("DEFAULT_MODEL", "openrouter:openai/gpt-oss-120b:free")
