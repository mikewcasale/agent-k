...
class TestParseBaselineScore:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("Baseline log_loss score: 1.5e-3", 1.5e-3),
            ("Baseline log_loss score: 2.5E-05", 2.5e-5),
            ("Baseline log_loss score: -1.2e+2", -120.0),
            ("Baseline RMSE score: +0.5", 0.5),
            ("Baseline RMSE score: .25", 0.25),
            ("Baseline RMSE score: 1.", 1.0),
            ("Baseline RMSE score: 7", 7.0),
            ("no score here", None),
            ("Baseline score: not-a-number", None),
            ("Baseline RMSE score: 0.1.2", 0.1),
            ("Baseline RMSE score: nan", None),
            ("Baseline RMSE score: -inf", None),
            ("Baseline RMSE score: 1e10000", None),
            ("Baseline RMSE score: 0.5\nBaseline RMSE score: 0.4", 0.5),
        ],
    )
