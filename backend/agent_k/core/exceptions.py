...
The exception hierarchy follows a three-level structure:
1. AgentKError - Base for all AGENT-K exceptions
2. Domain-specific bases (AgentError, AdapterError, etc.)
3. Specific exception types

All exceptions include structured data for observability.
"""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            context={'tool_name': tool_name, 'args': self.args},
        )
...
class PlatformConnectionError(AdapterError):
    ...
    def __init__(self, platform: str, message: str) -> None:
        ...
        super().__init__(
            f'[{platform}] Connection failed: {message}',
